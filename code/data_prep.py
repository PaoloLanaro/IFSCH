...
def process_dataset(input_images_dir, input_json_path, base_dir, test_size=0.2, val_size=0.1):
    ...
    try:
        ...
        if '_via_img_metadata' in merged_data:
            ...
            train_val_files, test_files = train_test_split(valid_image_files, test_size=test_size, random_state=42)
...
def main():
    ...
    parser.add_argument('--annotations', type=str, required=True, help='Path to merged VGG IA JSON annotation file')
    parser.add_argument('--output', type=str, default='./data', help='Output base directory for processed dataset')
    ...
    process_dataset(args.images, args.annotations, args.output)
